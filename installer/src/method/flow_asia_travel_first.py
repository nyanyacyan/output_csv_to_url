...
class FlowAsiaTravelFirst:
    ...
    def single_process(self):
        ...
        try:
            ...
            # キーワードの入力
            self.get_element.clickClearInput(value=self.const_element['KEYWORD_VALUE'], inputText=KeyWordInfo.ASIA_TRANSPORT.value)
            self.random_sleep._random_sleep(2, 5)
            ...
            # csvファイルに書き込めるように修正
            file_name = f"アジア渡航・交通情報_1_{self.timestamp_two}"
